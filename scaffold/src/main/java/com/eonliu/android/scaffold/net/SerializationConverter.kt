...
//                in 400..499 -> throw RequestParamsException(response, code.toString()) // 请求参数错误
//                500 -> throw ServerResponseException(response, code.toString()) // 服务器异常错误
                else -> throw ConvertException(response)
            }
        }
    }

    fun <R> String.parseBody(succeed: kotlin.reflect.KType): R? {
